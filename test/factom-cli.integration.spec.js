...
describe('Test FactomCli', function () {
    ...
    it('should get all entries of chain', async function () {
        ...
        assert.isArray(await cli.getAllEntriesOfChain('9f0901a2cdef23bb9cc8d06d8355d848f19d315808fdf70a614dd52dd6539689'));
    });

    it('should get chain head', async function () {
        assert.isObject(await cli.getChainHead('9f0901a2cdef23bb9cc8d06d8355d848f19d315808fdf70a614dd52dd6539689'));
    });

    it('should get entry', async function () {
        assert.isObject(await cli.getEntry('a37e7077146ead1fd8ee818cfcf9afa3ac1074a97324a75360722cd81cf28bc4'));
    });

    it('should get entry with block context', async function () {
        this.timeout(5000);

        assert.isObject(await cli.getEntryWithBlockContext('a37e7077146ead1fd8ee818cfcf9afa3ac1074a97324a75360722cd81cf28bc4'));
    });

    it('should get first entry', async function () {
        this.timeout(5000);

        assert.isObject(await cli.getFirstEntry('9f0901a2cdef23bb9cc8d06d8355d848f19d315808fdf70a614dd52dd6539689'));
    });

    it('should check chain exists', async function () {
        assert.isBoolean(await cli.chainExists('9f0901a2cdef23bb9cc8d06d8355d848f19d315808fdf70a614dd52dd6539689'));
    });

    it('should get balance', async function () {
        assert.isNumber(await cli.getBalance('FA3cnxxcRxm6RQs2hpExdEPo9utyeBZecWKeKa1pFDCrRoQh9aVw'));
    });
    ...
    it('should get transaction', async function () {
        assert.isObject(await cli.getTransaction('3dd83531164388d9a598fb8db63e0610f5c3b5c9411ca990f51b3406c8e81d0c'));
    });
    ...
    it('should rewind chain', async function () {
        ...
        let i = 0;
        await cli.rewindChainWhile('9f0901a2cdef23bb9cc8d06d8355d848f19d315808fdf70a614dd52dd6539689', () => true, () => i++);
    ...
    it('should create and send factoid transaction', async function () {
        ...
        const transaction = await cli.createFactoidTransaction(PAYING_FCT_ADDRESS, RECEIVING_FCT_ADDRESS, 1);
    ...
    it('should create and send EC purchase transaction', async function () {
        ...
        const transaction = await cli.createEntryCreditPurchaseTransaction(PAYING_FCT_ADDRESS, RECEIVING_EC_ADDRESS, 1);
        assert.isString(await cli.sendTransaction(transaction));
    });
    ...
    it('should get Directory Block', async function () {
        assert.isObject(await cli.getDirectoryBlock('b22ce9d405402a3ddaafa63914ebf8e0cec4fd4c8b8513fc786cd53c5254208c'));
    });

    it('should get Admin Block', async function () {
        assert.isObject(await cli.getAdminBlock('579d864ab69a3c4dd66730045a10831463ddc74a00293a54098e7ba125ff9950'));
    });

    it('should get Entry Credit Block', async function () {
        assert.isObject(await cli.getEntryCreditBlock('cf893ad2711c2e7d2daf5f0599d63fd63fc92674bcd046d0dbdb6a5742ea7a61'));
    });

    it('should get Factoid Block', async function () {
        assert.isObject(await cli.getFactoidBlock('7d7ba1f058c76bbc7b6aee2c645d15da79182fd2eaf39aebe1a8b9d40c8e9cc5'));
    });

    it('should get Entry Block', async function () {
        assert.isObject(await cli.getEntryBlock('308093c08f9c17a33cf21a3da89d7c28e8b3587b5d0119a50ab9e88e0bee39d4'));
    });
